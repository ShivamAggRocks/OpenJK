...
namespace Q
{
	...
	To describe an expected string literal, pass it as a const reference to gsl::cstring_span, e.g. `"foo bar"_v`; just as with sscanf a single whitespace is taken to mean "all available whitespace".
